            ...
            <div class="row">
                <div class="col-6">
                    <?php if(strlen($blogdata[$post_id]['picture'])>0) { ?>
                        <img style="width:400px;height: 400px;" src="<?php echo $blogdata[$post_id]['picture']; ?>" class="rounded float-left" alt="...">
                    <?php } else { ?>
                ...
                <div class="col text-center">
                    ...
                    <p>Band: <?php echo $blogdata[$post_id]['band'] ?></p>
                    <p>Album: <?php echo $blogdata[$post_id]['album'] ?></p>
                    <p>Song: <?php echo $blogdata[$post_id]['song'] ?></p>
                    <p>Tag(s): <?php echo $blogdata[$post_id]['tags'] ?></p>
                </div>
            </div>
            <hr>
